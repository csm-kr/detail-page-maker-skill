...
[`projects/domeggook-43314131/detail-page/index.html`](../../../../projects/domeggook-43314131/detail-page/index.html)에 800px 상한·360px 반응형 수정 가능 HTML 상세페이지를 완성했다.

- 도매꾹 공급처 기능·치수·재질·원산지 사실을 `data-fact-id`와 [`claim-evidence-map.json`](../../../../projects/domeggook-43314131/detail-page/claim-evidence-map.json)에 연결했다.
...
상세 QA는 [`qa/behance-rubric-report.md`](../../../../projects/domeggook-43314131/detail-page/qa/behance-rubric-report.md)를 따른다. 공급처 사실은 모두 사용자 승인 전 `publishable: false`이고 사용자 실사진 SSOT·가격·MOQ·옵션·관리법이 없으므로 판매 게시 승인은 차단한다.
