...
- 상태: `adopted`
- 날짜: 2026-07-25
- 증거: [`behance-commercial-analysis-20260725.md`](behance-commercial-analysis-20260725.md),
  [`Behance 캡처`](../research/evidence/behance-commercial-20260725/),
  [`Novaface GIF 접촉판`](../../projects/domeggook-60851997/qa/evidence/commercial-final-v8/gif-contact.png)
...
## 2026-07-26 채택 — 제품 문자는 OCR보다 구조 대조가 먼저다

- 실험: `STORTS`, `ZZOM/ZZOOM`, 기울어진 `ZOOM SPORTS`가 섞인 기존 소재를 실제품 SSOT를 함께 넣은 precise object edit로 각각 교정했다.
- 관찰: 한 프롬프트에서 제품 전체를 다시 만들기보다 `수정할 문자 / 보존할 구조 / 금지 철자 / 장축 방향`을 분리했을 때 실루엣과 부품 위치가 안정됐다.
- 채택 규칙: 블루쿠션은 `ZOOM SPORTS`, 흰 PU 양각은 `SPORTS`로 부품별 레지스트리를 만들고, 현재 공개 참조 자산과 GIF 3프레임을 확대한다.
