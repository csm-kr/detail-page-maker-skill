...
- 우측 상단 `편집 모드`를 누르면 76개 카피가 직접 편집된다.
...
- 치수 구간 설명: [`videos/dimension-guide-motion`](../../../videos/dimension-guide-motion)
- 감자 눈 제거 돌기 접촉: [`videos/potato-eye-motion`](../../../videos/potato-eye-motion)
