...
근거와 예시는 [`prototypes/domeggook-43314131/report.md`](../../../prototypes/domeggook-43314131/report.md)와 [`supplier-facts.json`](../../../prototypes/domeggook-43314131/supplier-facts.json)에 기록했다. 원본 bundle은 `.artifacts/` 아래 로컬 증거로 보존하고 저장소에는 포함하지 않는다.
