...
- [실제품 기반 노바페이스 기능성 깔창 commercial-final v10](issues/24-prototype-actual-product-air-cushion-insole.md) —좌우 거울 대칭 아치, 제품 인쇄 철자·장축, 역할형 HyperFrames GIF 9개, 착화 사용 장면 4종+제품 인셋과 5개 폭 QA를 연결해 98/100·하드 실패 0개로 마감했다.
