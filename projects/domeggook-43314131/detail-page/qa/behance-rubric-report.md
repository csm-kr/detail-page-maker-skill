...
기준: `historical-commercial-rubric`, Behance 상세페이지 원본 프로젝트 공통 문법
...
- 기록 ID `final-page-qa-v3`
- 기록 ID `responsive-final-v3`
- 기록 ID `dimension-gap-and-taste-final`
- 기록 ID `taste-edit-mode-final-dom`
