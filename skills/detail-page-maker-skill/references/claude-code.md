...
└──────────────────────────────────────────────────────────────────┘
   ...
   │  (G2로 복귀)          ║  codex : 보이는 것을 그대로 서술       ║
   │                       ║  본인   : 기대값 대조 · SSOT 사실 일치 ║
   │                       ╚═══════════════════╤══════════════════╝
   │                                        PASS (둘 다)
   │ G3  모션                        ┌───────────────────────────┐
   ├───────────────────────────────► │ HyperFrames → MP4         │
...
| 맡길 것 | 사람·사물 수, 색, 부품 방향과 결합, 프레임 간 튐과 잔상, 잘림·겹침·깨진 글자 | 기대값 대조, SSOT 사실 일치, 루프 산술, 카피 청킹, 판매 논리, 스킬 안전선 |
