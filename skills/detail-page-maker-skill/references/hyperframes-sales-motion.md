...
한 GIF에서 포인트는 최대 3개이며 활성 포인트만 밝히고 각 포인트를 0.8~1.2초
유지한다. 긴 문장·교차 화살표·동시 점멸은 금지한다.
...
- 사용법은 한 GIF에 최대 3단계만 넣고 짧은 동사, 방향 화살표, pulse, 완료 check를 쓴다.
...
프로젝트 전체에 기본 전환 한 계열을 두고 강조 전환은 최대 1~2개만 사용한다.
