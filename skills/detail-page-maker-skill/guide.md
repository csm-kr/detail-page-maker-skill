...
| 디자인 실험 | 설치된 `design-taste-frontend` 스킬 | [`study-design-skill.md`](references/study-design-skill.md), [`behance-commercial-analysis.md`](references/behance-commercial-analysis.md) |
...
- 연구 메모리: `study-design-skill`, `behance-commercial-analysis`,
